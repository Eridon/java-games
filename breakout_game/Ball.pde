class Ball
{
  ...
  boolean move(int batY, int batW) // returns true if ball "ok", false if it's "lost"
  {
   ...
   for (int i=0; i<Bricks.size(); i++)
   {
     ...
     if ((x>=b.x) && (x<=b.x+BRICKW) && (y==b.y+BRICKH)) // bottom of brick
     {
       Bricks.remove(i);
       offsetY=-offsetY;
     }
     else
     if ((x>=b.x) && (x<=b.x+BRICKW) && (y==b.y)) // top of brick
     {
       Bricks.remove(i);
       offsetY=-offsetY;
     }
     else
     if ((y>=b.y) && (y<=b.y+BRICKH) && (x==b.x-diam)) // left of brick
     {
       Bricks.remove(i);
       offsetX=-offsetX;
     }
     else
     if ((y>=b.y) && (y<=b.y+BRICKH) && (x==b.x+BRICKW)) // right of brick
     {
       Bricks.remove(i);
       offsetX=-offsetX;
     }
